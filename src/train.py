...
def train(model,data_loader,test_loader,device,epochs,optimizer,criterion, learning_rate = 1e-3):
    '''
    Train the model 
    Inputs: 
    learning rate,
...
# Training loop
    ...
    torch.save(best_state_dict, os.path.join(directory, 'best_model.pth'))  # name +'.pth'))  
